...
{
internal class MK_StandardShaderGUI : ShaderGUI
{
	...
	private static class Styles
	{
		...
		public static string mk_glow_system = "MK Glow System";
		public static GUIContent mk_glow_color = new GUIContent("Glow Color");
	...
	MaterialProperty mk_glow_system_material_color = null;
	MaterialProperty mk_glow_system_material_glowPower = null;
	MaterialProperty mk_glow_system_material_glowtex = null;
	MaterialProperty mk_glow_system_material_glowtexColor = null;
	MaterialProperty mk_glow_system_material_glowtexColorStrength = null;
	MaterialProperty mk_glow_system_material_glowOffset = null;
	...
	public void ShaderPropertiesGUI (Material material)
	{
		...
		EditorGUI.BeginChangeCheck();
		{
			...
			GUILayout.Label(Styles.mk_glow_system, EditorStyles.boldLabel);
			DoMKGlowArea(material);
